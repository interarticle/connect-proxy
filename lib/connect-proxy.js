 ...
 *   - `ipHeader`   header property in which originating ip address and additional proxy ip
...
exports.realValues = function(options) {
  ...
  return function (req, res, next) {
    ...
    if (req.connection.addressOverriden  || isTrusted(ipValue.concat(req.connection.remoteAddress), trustedRange)) {
      req.connection.__defineGetter__('remoteAddress', function(){ return originatingIp; });
	  req.connection.addressOverriden = true;
